                ...
                <form data-vv-scope="confirmation_form">
                    ...
                    <div v-if="order_restaurant_mode == 1">
                        ...
                        <div class="form-group col-md-6 p-0">
                            ...
                            <cool-select type="text" name="waiter" v-model="waiter" v-validate="" class="" :placeholder="$t('Choose Waiter')"  autocomplete="off" :items="waiter_list" item-text="fullname" itemValue='slack' :resetSearchOnBlur='false' disable-filtering-by-search @search="load_waiters($event)" ref="waiter" key='waiter'>
                                <template #item="{ item }">
                                    <div class='d-flex justify-content-start'>
                                    <div>
                                        {{ item.fullname }} - {{ item.user_code }}
                                    </div>
                                    </div>
                                </template>
                            </cool-select>
            ...
            <template v-slot:quick-panel-body>
                ...
                <div v-show="running_order_list_processing == false">
                    ...
                    <div v-if="running_order_list_filtered.length>0">
                        <div class="list-item mb-3" v-for="(running_order_list_item, index) in running_order_list_filtered" v-bind:value="running_order_list_item.slack" v-bind:key="index" v-on:click="go_to_order(running_order_list_item.edit_link)">
                            <div class="d-flex justify-content-between mb-2">
                                <div class="mr-auto">
            ...
            <template v-slot:quick-panel-body>
                ...
                <div v-show="hold_list_processing == false">
                    ...
                    <div v-if="hold_list_filtered.length>0">
                        <div class="list-item mb-3" v-for="(hold_order_list_item, key, index) in hold_list_filtered" v-bind:key="index" v-on:click="go_to_order(hold_order_list_item.edit_link)">
                            <div class="form-row">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6 mb-0">
                                    <label for="type">{{ $t("Customer Phone") }}</label>
            ...
            <template v-slot:quick-panel-body>
                ...
                <div v-show="digital_menu_order_list_processing == false">
                    ...
                    <div v-if="digital_menu_order_list_filtered.length>0">
                        <div class="list-item mb-3" v-for="(digital_menu_order_list_item, index) in digital_menu_order_list_filtered" v-bind:value="digital_menu_order_list_item.slack" v-bind:key="index" v-on:click="go_to_order(digital_menu_order_list_item.edit_link)">
                            <div class="d-flex justify-content-between mb-2">
                                <div class="mr-auto">
                ...
                this.$on("submit",function () {
                    ...
                    this.$validator.validateAll('confirmation_form').then((isValid) => {
                        if (isValid) {
                            ...
                            formData.append("customer_number", (this.customer_number != null && this.customer_number != '')?this.customer_number:'');
                            formData.append("customer_email", (this.customer_email != null && this.customer_email != '')?this.customer_email:'');
