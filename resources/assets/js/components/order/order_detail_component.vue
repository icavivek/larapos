        ...
        <div class="col-md-12">
            ...
            <div class="d-flex flex-wrap mb-4">
                ...
                <div class="ml-auto">
                    ...
                    <button type="button" class="btn btn-outline-primary mr-1" v-if="share_invoice_sms_access == true" v-on:click="share_invoice_as_sms()" v-bind:disabled="send_sms_processing == true"> <i class='fa fa-circle-notch fa-spin'  v-if="send_sms_processing == true"></i> {{ $t("Share Invoice as SMS") }}</button>

                    <a class="btn btn-outline-primary" v-if="order_basic.status.value == 1" v-bind:href="print_order_link" target="_blank">{{ $t("Print") }}</a>
