        ...
        <div class="container-fluid pl-0 pr-0">
            <div class="content mt-5 pl-3 pr-3">
                ...
                <div class="d-flex justify-content-center mb-4">
                    <span class="text-display-0">Server Requirements Checker</span>
                </div>
                <div class="d-flex justify-content-center mb-4">
                ...
                <div class="d-flex flex-column mb-4">
                    ...
                    <div class="d-flex justify-content-center text-center mb-1">
                        <div class="d-flex flex-column">
                            <div>
                                <p class="mb-0"><?php echo $server_requirements['proc_open_enabled'] ? $matched : $missed; ?>&nbsp;<span class='text-info'>proc_open</span> Function</p>
                            </div>
                ...
                <div class="d-flex justify-content-center mb-0">
                    <small class="text-muted">Version 3</small>
                </div>
