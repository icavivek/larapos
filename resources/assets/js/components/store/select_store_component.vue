        ...
        <div class="d-flex justify-content-center pt-5">
            <div class="col-sm-12 col-md-8 col-lg-6 col-lg-6">
                <div class="d-flex flex-wrap mb-1">
                    <div class="mr-auto">
                        <span class="text-title">Choose Store</span>
                    </div>
                    <div class="">
                ...
                <div class="store-list border-top border-bottom">
                    ...
                    <div class="d-flex flex-column p-3" v-if="stores.length == 0 && is_super_admin == false">
                        <p class="mb-1">Oh, currently you dont have any store access. Please contact your administartor for store access.</p>
                    </div>
                    <div class="d-flex flex-column p-3" v-if="stores.length == 0 && is_super_admin == true">
                        <p class="mb-1">You can add a store to get started.</p>
                    </div>
                </div>
                <div class="mt-2">You can choose from {{ stores.length }} store(s)</div>
            </div>
        </div>
    </div>
</template>
