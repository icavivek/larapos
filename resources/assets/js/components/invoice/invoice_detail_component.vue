    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="d-flex flex-wrap mb-4">
                ...
                <div class="ml-auto">
                    ...
                    <a class="btn btn-outline-primary mr-1" v-bind:href="'/print_invoice/'+slack" target="_blank">{{ $t("Print") }}</a>
        ...
        <modalcomponent v-if="show_payment_modal" v-on:close="show_payment_modal = false" :modal_width="'modal-container-md'">
            ...
            <template v-slot:modal-body>
                <addtransactionwidgetcomponent :transaction_type_data="transaction_type_data" :accounts="accounts" :payment_methods="payment_methods" :invoice_slack="slack" :bill_to_prop="'INVOICE'" :currency_codes="currency_codes"></addtransactionwidgetcomponent>
            </template>
