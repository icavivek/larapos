...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="d-flex flex-wrap mb-4">
            <div class="mr-auto">
                <span class="text-title">{{ __("SMS Templates") }}</span>
            </div>
            <div class="">
            </div>
        </div>
...
@push('scripts')
    ...
    <script src="{{ secure_asset('js/pages/sms_templates.js') }}"></script>
    <script>
        'use strict';
        var sms_templates = new SmsTemplates();
        sms_templates.load_listing_table();
    </script>
@endpush