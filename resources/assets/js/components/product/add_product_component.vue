    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form @submit.prevent="submit_form" class="mb-3">
                ...
                <div class="d-flex flex-wrap mb-1">
                    <div class="mr-auto">
                        <span class="text-subhead">{{ $t("Product Identifier Information") }} ({{ $t("Optional") }})</span>
                    </div>
                    <div class="">
                ...
                <div class="form-row mb-2">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" name='quantity' v-model="quantity" v-validate="quantity_validate" class="form-control form-control-custom" :placeholder="$t('Please enter quantity')"  autocomplete="off" step="1" min="0">
                        <span v-bind:class="{ 'error' : errors.has('quantity') }">{{ errors.first('quantity') }}</span> 
                    </div>
                    <div class="form-group col-md-3">
                        <label for="status">{{ $t("Stock Alert Quantity") }}</label>
                        <input type="number" name='alert_quantity' v-model="alert_quantity" v-validate="'decimal'" class="form-control form-control-custom" :placeholder="$t('Please enter stock alert quantity')"  autocomplete="off" step="1" min="0">
                    ...
                    <div class="form-row mb-2">
                        <div class="form-group col-md-3">
                            ...
                            <multiselect  v-model="addon_group_values" :options="addon_groups" :multiple="true" :close-on-select="false" :clear-on-select="false" :preserve-search="true" placeholder="Choose Add-on Groups" label="label" track-by="slack" :preselect-first="false">
                                <template slot="selection" class="form-control" slot-scope="{ values, search, isOpen }"><span class="multiselect__single" v-if="values.length &amp;&amp; !isOpen">{{ values.length }} options selected</span></template>
                            </multiselect>
                        </div>
                    </div>
                    <hr>
                    ...
                    <div>
                        <div class="form-row mb-2">
                            <div class="form-group col-md-4">
                                <label for="barcode">{{ $t("Search and Add Ingredients") }}</label>
                        ...
                        <div class="form-row mb-2">
                            <div class="form-group col-md-6">
                                <div class="custom-control custom-switch">
                                    <input type="checkbox" class="custom-control-input" id="is_ingredient_price" v-model="is_ingredient_price">
