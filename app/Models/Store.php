...
class Store extends Model
{
    ...
    protected $fillable = ['slack', 'store_code', 'name', 'tax_number', 'tax_code_id', 'discount_code_id', 'address', 'country_id', 'pincode', 'primary_contact', 'secondary_contact', 'primary_email', 'secondary_email', 'invoice_type', 'currency_name', 'currency_code', 'restaurant_mode', 'restaurant_waiter_role_id', 'restaurant_billing_type_id', 'enable_customer_popup', 'enable_digital_menu_otp_verification', 'digital_menu_send_order_to_kitchen', 'menu_language_id', 'status', 'created_by', 'updated_by', 'created_at', 'updated_at'];
