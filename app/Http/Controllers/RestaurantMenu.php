...
class RestaurantMenu extends Controller
{
    ...
    public function our_menu(Request $request, $store_slack, $table_slack = null){
        ...
        $store_data = StoreModel::select('id', 'slack', 'name', 'address', 'currency_code', 'tax_code_id', 'discount_code_id', 'restaurant_billing_type_id', 'restaurant_mode', 'enable_digital_menu_otp_verification', 'menu_language_id')
        ...
        $data['navbar_logo'] = config("app.navbar_logo");
