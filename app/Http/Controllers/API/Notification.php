...
class Notification extends Controller
{
                ...
                if(!empty($sms_setting_data)){
                    ...
                    switch($sms_setting_data->gateway_type){
                        ...
                        case 'MSG91':
                            ...
                            try{
                                $this->send_sms_msg91($auth_key, $sender_id, $recipient_number, $message);
                            }catch(Exception $e){
    ...
    public function send_sms_msg91($auth_key, $sender_id, $recipient_number, $message){
        //Use route value as 4 for transactional messages and 1 for promotional.
        $route = "4";
