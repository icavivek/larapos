...
class Order extends Controller
{
    ...
    public function add_order(Request $request, $slack = null){
        ...
        $business_register_data = BusinessRegisterModel::select('slack')
        ...
        $store_data = StoreModel::select('tax_code_id', 'discount_code_id', 'currency_code', 'restaurant_billing_type_id', 'restaurant_waiter_role_id', 'enable_customer_popup')
        ->where([
        ...
        if(isset($slack)){
            ...
            //$order_products = OrderProductModel::where('order_id', $order->id)->get();
